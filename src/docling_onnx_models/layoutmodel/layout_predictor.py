...
class LayoutPredictor(BaseONNXPredictor):
    ...
    def _load_configs(self):
        ...
        self._image_mean = self._processor_cfg.get(
            "image_mean", [0.485, 0.456, 0.406]
        )
        self._image_std = self._processor_cfg.get(
    ...
    def predict(self, page_img: Union[Image.Image, np.ndarray]) -> Generator[dict, None, None]:
        """
